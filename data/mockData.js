...
export const MOCK_GATHERINGS = [
    {
        ...
        participants: 12,
        participantList: [
            { id: 'u1', name: '小黑', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=u1', isFriend: true },
            { id: 'u2', name: '阿黃', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=u2', isFriend: true },
            { id: 'u3', name: '小白', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=u3', isFriend: false },
            { id: 'u4', name: '斑斑', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=u4', isFriend: false },
            { id: 'u5', name: '皮皮', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=u5', isFriend: true },
        ],
    ...
    },
    {
        ...
        participants: 5,
        participantList: [
            { id: 'u6', name: '咪咪', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=u6', isFriend: false },
            { id: 'u7', name: '花花', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=u7', isFriend: true },
            { id: 'u8', name: '毛毛', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=u8', isFriend: false },
        ],
